...
[![release v0.4.3](http://img.shields.io/badge/release-v0.4.3-blue.svg)](https://github.com/faysou/MTools/releases/latest)
...
1. Download the latest released
   [MTools.zip](https://github.com/faysou/MTools/releases/download/0.4.3/MTools.zip)
   file.
