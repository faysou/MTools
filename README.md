...
[![release v0.2.1.0](http://img.shields.io/badge/release-v0.2.1.0-blue.svg)](https://github.com/faysou/MTools/releases/latest)
[![Semantic Versioning](https://img.shields.io/badge/SemVer-2.1.0-green.svg)](http://semver.org/spec/v2.1.0.0.html)
...
1. Download the latest released
   [MTools.zip](https://github.com/faysou/MTools/releases/download/0.2.1.0/MTools.zip)
   file.
